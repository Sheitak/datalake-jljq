...
dag = DAG(
    ...
    description='DAG pour l\'ingestion de données Alpha Johan',
...
def extract_sentiment_news_data():
    s3_object_key = 'johan/coingecko/data/news-sentiment.csv'
    alpha_vintage_url = f'https://pro-api.coingecko.com/api/v3/coins/list'
